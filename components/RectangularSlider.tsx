...
const slides: Slide[] = [
    ...
    },
    {
        ...
        tag: "BOHO CHIC • MAXI GOWN",
        title: "Mustard Yellow Floral Line-Art Maxi Gown",
        subtitle: "A sunny mustard yellow maxi gown accented with white line-art floral prints and elegant elbow-length flared sleeves.",
        price: "₹950",
        color: "Mustard Yellow & White",
        accentColor: "#FBC02D",
        bgGradient: "radial-gradient(ellipse at 80% 50%, rgba(251, 192, 45, 0.25) 0%, rgba(20, 18, 22, 0.98) 70%)",
